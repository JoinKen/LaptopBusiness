...
class DealItem extends Component {
    ...
    render() {
        return (
            ...
            //     <div className="deals_image"><img src="/upload/best_1.png" alt /></div>
            //     <div className="deals_content">
            //         <div className="deals_info_line d-flex flex-row justify-content-start">
            //             <div className="deals_item_category"><a href="#">Mac</a></div>
            //             <div className="deals_item_price_a ml-auto">$500</div>
            //         </div>
            //         <div className="deals_info_line d-flex flex-row justify-content-start">
            //             <div className="deals_item_name">Mac Pro</div>
            //             <div className="deals_item_price ml-auto">$500</div>
            //         </div>
            //         <div className="available">
            //             <div className="available_line d-flex flex-row justify-content-start">
            //                 <div className="available_title">Available: <span>5</span></div>
            //                 <div className="sold_title ml-auto">Already sold: <span>10</span></div>
            //             </div>
