                    ...
                    <div className="col">
                            ...
                            <div className="owl-carousel owl-theme reviews_slider">
                                ...
                                <div className="owl-item">
                                    <div className="review d-flex flex-row align-items-start justify-content-start">
                                        <div>
                                            <div className="review_image"><img src="./assets/images/review_1.jpg" alt /></div>
                                        </div>
                      ...
                      fermentum laoreet.</p>
                                ...
                                <div className="owl-item">
                                    <div className="review d-flex flex-row align-items-start justify-content-start">
                                        <div>
                                            <div className="review_image"><img src="./assets/images/review_2.jpg" alt /></div>
                                        </div>
                                        <div className="review_content">
                      ...
                      fermentum laoreet.</p>
                                ...
                                <div className="owl-item">
                                    <div className="review d-flex flex-row align-items-start justify-content-start">
                                        <div>
                                            <div className="review_image"><img src="./assets/images/review_3.jpg" alt /></div>
                                        </div>
                                        <div className="review_content">
