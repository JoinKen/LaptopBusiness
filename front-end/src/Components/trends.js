...
const banner = () => {
    return (
        ...
        <div className="trends">
            <div className="trends_background" style={{ backgroundImage: 'url(./assets/images/trends_background.jpg)' }} />
                            ...
                            <div className="owl-carousel owl-theme trends_slider">
                                ...
                                <div className="owl-item">
                                    <div className="trends_item is_new">
                                        <div className="trends_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="./assets/images/trends_1.jpg" alt /></div>
                                ...
                                <div className="owl-item">
                                    <div className="trends_item">
                                        <div className="trends_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="./assets/images/trends_2.jpg" alt /></div>
                                        <div className="trends_content">
                                            <div className="trends_category"><a href="#">Smartphones</a></div>
                                            <div className="trends_info clearfix">
                                                <div className="trends_name"><a href="product.html">Samsung Charm...</a>
                                                </div>
                                                <div className="trends_price">$379</div>
                                            </div>
                                        </div>
                                ...
                                <div className="owl-item">
                                    <div className="trends_item is_new">
                                        <div className="trends_image d-flex flex-column align-items-center justify-content-center">
                                            <img src="./assets/images/trends_3.jpg" alt /></div>
                                        <div className="trends_content">
                                            <div className="trends_category"><a href="#">Smartphones</a></div>
                                            <div className="trends_info clearfix">
                                                <div className="trends_name"><a href="product.html">DJI Phantom 3...</a>
                                                </div>
                                                <div className="trends_price">$379</div>
                                            </div>
                                        </div>
